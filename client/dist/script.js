...
var User = /** @class */ (function () {
    ...
    User.prototype.addUser = function (arr) {
        ...
        var out = "";
        out = "<tr>\n<td>".concat(newUser[0], " </td>\n<td>").concat(newUser[1], "</td>\n<td>").concat(newUser[2], "</td>\n<td>").concat(newUser[3], "</td>\n<td>").concat(newUser[4], "</td>\n<td>").concat(newUser[5], "</td>\n<td>").concat(newUser[6], "</td>\n<td>").concat(dat, "</td>\n\n<td id=\"buttons\"><button onclick=\"buttons(this)\">Edit</button> <button onclick=\"removeTr(this)\">Delete</button></button></td>\n</tr>");
...
function load() {
    ...
    fetch("/server/dist/controllers/data.json")
